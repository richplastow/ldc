...
(function(_oG) {
/*! Ldc 0.0.3 //// MIT Licence //// http://ldc.richplastow.com/ */
...
tudor.add([
  "02 Ldc::add()", tudor.is, "`add()` is a function which returns a string", function() {
    ...
    return ldc.items.length;
  }, "`uid` exceptions", tudor["throw"], "Is boolean", "/ldc/src/Ldc.litcoffee Ldc::add()\n  argument uid is type boolean not string", function(ldc) {
    return ldc.add('Hat', {}, true);
  }, "Empty string", "/ldc/src/Ldc.litcoffee Ldc::add()\n  argument uid fails ^[a-z]\\w{1,23}$", function(ldc) {
    return ldc.add('Hat', {}, '');
