...
var Ldc, SomeClass, Tudor, _o, _oT, _oV, tudor,
...
tudor.add([
  "02 Ldc::add()", tudor.is, "`add()` is a function which returns a string", function() {
    ...
    return ldc.add('Hat');
  }, "The `kind` argument accepts class-names as expected", tudor.equal, "'Sine' is a recognized class-name", 2, function(ldc) {
    ldc.add('Sine');
  ...
  }, "Not a recognized class-name", "/ldc/src/Ldc.litcoffee Ldc::add()\n  argument kind fails ^Sine$|^Hat$", function(ldc) {
    return ldc.add('Xyz');
  }, "The `config` argument accepts an object as expected", tudor.equal, "An empty object", 3, function(ldc) {
    ldc.add('Hat', {});
    return ldc.items.length;
  }, "An object with arbitrary content", 4, function(ldc) {
    ldc.add('Hat', {
      a: 1,
      b: 2
    });
    return ldc.items.length;
  }, "Can be undefined", 5, function(ldc) {
    ldc.add('Hat', void 0);
    return ldc.items.length;
  ...
  }, "The `uid` argument accepts a string as expected", tudor.equal, "Shortest possible uid", 6, function(ldc) {
  ...
  }, "Can repeat existing uid, if case is different", 8, function(ldc) {
