...
tudor.add([
  "02 Ldc::addItem()", tudor.is, "`addItem()` is a function which returns a string", function() {
  ...
  }, "Must be unique", "/ldc/src/Ldc.litcoffee Ldc::addItem()\n  an Item with uid 'the_last' already exists", function(ldc) {
    ...
    return ldc.items._first.uid;
  }, "The last Item is 'the_last'", 'the_last', function(ldc) {
    return ldc.items._last.uid;
...
tudor.add([
  ...
  }, "`Item::uid` is a string", _o.S, function() {
    return (new Item({
      uid: 'abc',
      prev: null,
      next: null
...
tudor.add([
  ...
  }, "The `uid` argument accepts a string as expected", tudor.equal, "Shortest possible uid", 0, function(ldc) {
    ldc.addItem('Hat', {}, 'aB');
    ldc.deleteItem('aB');
    return ldc.items._length;
  }, "Longest possible uid", void 0, function(ldc) {
    ldc.addItem('Hat', {}, 'abcdefghijklmnopqrst123_');
    ldc.deleteItem('abcdefghijklmnopqrst123_');
    return ldc.items.abcdefghijklmnopqrst123_;
  }, "`uid` exceptions", tudor["throw"], "Is an array", "/ldc/src/Ldc.litcoffee Ldc::deleteItem()\n  argument uid is type array not string", function(ldc) {
