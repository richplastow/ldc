...
(function(_oG) {
/*! Ldc 0.0.8 //// MIT Licence //// http://ldc.richplastow.com/ */
...
Ldc = (function() {
  ...
  Ldc.prototype.addItem = function(kind, config, id) {
    ...
    if (this.items._length) {
      this.items._last.next = item;
    } else {
      this.items._first = item;
    }
    this.items._last = item;
    this.items[id] = item;
    this.items._length++;
    return id;
  };
...
tudor.add([
  ...
  }, "`_length`, `_first`, `_last`, `prev` and `next` as expected", tudor.equal, "The first Item is 'the_first'", 'the_first', function(ldc) {
...
tudor.add([
  ...
  }, "`_length`, `_first`, `_last`, `prev` and `next` as expected", tudor.equal, "After deleting 'abc123', `items._length` is 0...", 0, function(ldc) {
